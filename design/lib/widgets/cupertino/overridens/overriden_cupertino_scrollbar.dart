...
// to the top.
// fix https://github.com/flutter/flutter/issues/32175
...
class OverridenCupertinoScrollbar extends RawScrollbar {
  /// Creates an iOS style scrollbar that wraps the given [child].
  ///
  /// The [child] should be a source of [ScrollNotification] notifications,
  /// typically a [Scrollable] widget.
  const OverridenCupertinoScrollbar({
  ...
  @override
  RawScrollbarState<OverridenCupertinoScrollbar> createState() => _OverridenCupertinoScrollbarState();
}

class _OverridenCupertinoScrollbarState extends RawScrollbarState<OverridenCupertinoScrollbar> {
