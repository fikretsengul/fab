...
extension ThemeExt on BuildContext {
  ...
  Color get onQuaternary => Theme.of(this).colorScheme.onPrimaryContainer;
  Color get quinary => Theme.of(this).colorScheme.secondaryContainer;
  Color get onQuinary => Theme.of(this).colorScheme.onSecondaryContainer;
  Color get senary => Theme.of(this).colorScheme.tertiaryContainer;
  Color get onSenary => Theme.of(this).colorScheme.onTertiaryContainer;
